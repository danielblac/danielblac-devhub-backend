...
let BlogPostsService = class BlogPostsService {
    ...
    async create(dto) {
        try {
            ...
            console.error(...oo_tx(`2016710268_44_6_44_55_11`, 'Error creating blog post:', error));
    ...
    async findAll(filters) {
        try {
            ...
            console.error(...oo_tx(`2016710268_98_6_98_58_11`, 'Error retrieving blog posts:', error));
    ...
    async findBySlug(slug) {
        try {
            ...
            throw new common_1.BadRequestException('Invalid blog post slug');
        }
    }
    async update(id, dto) {
        try {
    ...
    async likePost(id) {
        try {
            ...
            throw new common_1.InternalServerErrorException('Failed to like blog post');
        }
    }
    async viewPost(id) {
        try {
    ...
    async getCategories() {
        try {
            ...
            console.error(...oo_tx(`2016710268_296_6_296_58_11`, 'Error retrieving categories:', error));
            throw new common_1.InternalServerErrorException('Failed to retrieve categories');
        }
    }
    async getTags() {
        try {
            ...
            console.error(...oo_tx(`2016710268_307_6_307_52_11`, 'Error retrieving tags:', error));
            throw new common_1.InternalServerErrorException('Failed to retrieve tags');
        }
    }
    generateSlug(title) {
        return title
    ...
    async getRelatedPosts(id, limit = 3) {
        try {
            ...
            throw new common_1.InternalServerErrorException('Failed to retrieve related posts');
        }
    }
};
